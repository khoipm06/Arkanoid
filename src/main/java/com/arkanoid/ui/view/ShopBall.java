...
import com.arkanoid.core.entities.Ball;
    ...
    public class ShopBall {
        private static class SkinItem {
            ...
            private void updateUI() {
                ...
                if (currentUser != null) {
                    ...
                    // bạn có thể gán lên Label trong giao diện, ví dụ:
        ...
        @FXML private Button buy1, buy2, buy3;
        @FXML private Button equip1, equip2, equip3;
        @FXML private Button back;
        @FXML private Label lblMoney;
        @FXML private ImageView imgFire, imgIce, imgRainbow;
        ...
        @FXML
        public void onBuy1Click(MouseEvent event) { buySkin("Fire"); }
        @FXML
        public void onBuy2Click(MouseEvent event) { buySkin("Ice"); }
        @FXML
        public void onBuy3Click(MouseEvent event) { buySkin("Rainbow"); }
