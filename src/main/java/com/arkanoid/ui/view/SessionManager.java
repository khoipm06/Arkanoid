...
public class SessionManager {
    ...
    public static class User {
        ...
        public void addOwnedPaddleSkin(String skin) {
            ownedPaddleSkins.put(skin, true);
        }

        public boolean hasPaddleSkin(String skin) {
            return ownedPaddleSkins.getOrDefault(skin, false);
        }

        public String getEquippedPaddleSkin() {
            return equippedPaddleSkin;
        }

        public void setEquippedPaddleSkin(String skin) {
            this.equippedPaddleSkin = skin;
        }
        ...
        public Map<String, Boolean> getOwnedPaddleSkins() {
    ...
    public static void savePlayer(PlayerProfile player) {
        if (currentUser != null) {
            System.out.println("💾 Đã lưu user: " + currentUser.getUsername() + " | Tiền: " + currentUser.getMoney()
